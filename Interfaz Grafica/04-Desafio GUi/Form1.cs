    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (StreamWriter writer = new StreamWriter(rutaArchivo))
            {
                ...
                writer.WriteLine("==========================");
                writer.WriteLine("Nombre       Cantidad    Precio Unitario.    Subtotal    Total");
                writer.WriteLine("----------------------------------------------------------");
                ...
                foreach (DataGridViewRow row in dtgwMinifactura.Rows)
                {
                        ...
                        row.Cells["Total"].Value != null)
                    {
                        ...
                        decimal precioUnitario = Convert.ToDecimal(row.Cells["Precio_Unit"].Value);
        ...
        private void dtgwMinifactura_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
