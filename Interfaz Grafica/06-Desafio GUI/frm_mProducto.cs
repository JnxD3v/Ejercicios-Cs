    ...
    public partial class frm_mProducto : Form
    {
        ...
        private void btn_agregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dtgw_productos.Rows[Fila].Cells[0].Value = Fila.ToString();
                dtgw_productos.Rows[Fila].Cells[1].Value = txt_nombre.Text;
                dtgw_productos.Rows[Fila].Cells[2].Value = txt_categoria.Text;
                dtgw_productos.Rows[Fila].Cells[3].Value = n.ToString("C2");
                dtgw_productos.Rows[Fila].Cells[4].Value = txt_stock.Text;
            }
